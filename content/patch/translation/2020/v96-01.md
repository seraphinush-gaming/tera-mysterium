...
- Added system to change random options on gear and accessories
  - Item | Effect
    ...
    - Kalligar's Essence : Ring | Item used to lock random options when using Coveted Option Modifier. can be obtained by dismantling Warlord's Bracing Ring
    - Kalligar's Essence : Necklace | Item used to lock random options when using Coveted Option Modifier. can be obtained by dismantling Warlord's Bracing Necklace
