...
### 1. Dungeon
- Adjusted Execution Arena (pl.) balance
  - Slightly decreased Attack of Gardan (pl.)
  - Slightly adjusted damage of ice puddle from the arena (pl.)
  - Decreased duration of ice puddle in Execution Arena (hard) (pl.)
  ...
  - Fixed to prevent frost release (pl.) abnormality from ending upon death in normal and hard mode
...
- Fixed issue where Execution Arena (pl.) location was displayed as Execution Arena (hard) (pl.)
- Fixed issue in Execution Arena (pl.) where 2 stacks of frost abnormality increased movement speed
- Fixed issue in Execution Arena (pl.) where target mechanic applied to the executionee
- Fixed issue in Execution Arena (pl.) where boss' Unleash mechanic' abnormality is displayed as something else
