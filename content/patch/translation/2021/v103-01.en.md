...
### 1. Dungeon
- Added new dungeon : Execution Arena (5- Person)

| Execution Arena requirement ||
| :-: | :-: |
| Entry limit | No limit |
| Adventure Coin | 280 |
| Entry level | 70 |
| IMS ilevel | 496 |
| Execution Arena (hard) requirement ||
| Entry limit | No limit |
| Adventure Coin | 350 |
| Entry level | 70 |
| IMS ilevel | 501 |

  - Execution Arena loot table includes :
    - Tyrant's Belt, Card Fragment - Tyrant Gardan, Kaia's Soul Cryolite, Thulsan Legion War Trophy Chest (pl.), Soul Option Change Scroll, Magic Alloy, Azart Force War Trophy Chest, Sea of Honor Voyage Map, superior Relic / Halidom, Common / Uncommon Card Fragment Box
  - Execution Arena (hard) loot table includes :
  ...
  - Added one-time quest '[Dungeon - 496] [Party] Execution Arena', automatically acquired
...
|''| Ruinous Manor | Execution Arena | Execution Arena (hard) |
|''| Akalath Quarantine | Draakon Arena | Bahaar's Sanctum |
|''|| Forbidden Arena [Undying Warlord] | Corrupted Skynest (hard) |
|''|| Corrupted Skynest ||

- Added Thulsan Legion Loot Chest (pl.) to dungeon drop table
  - Thulsan Legion Loot Chest (pl.) : Gives 1 'Tyrant's Belt'
  - Thulsan Legion War Trophy Chest (pl.) : Gives 1 'Tyrant's Soul'
...
|''| [Dungeon - 496] [Party] Execution Arena | 70 | 496 |
...
### 7. Battleground
- Revised Gridiron
  - Placed Combat Monolith (pl.) at each team's spawn point
    - Breaking the monolith (pl.) applies 30% increase in Power and 20% decrease in cooldown to all party members (for a duration of 20 seconds)
  - Placed Enigmatic Boxes (pl.) around the battleground
...
|''| Superior Recovery Potable | 5 |
|''| Superior Replenishment Potable | 5 |
| [Daily] Exodor Fishing! So Much Fun! (pl.) | XP | 100,000,000 |
|''| EP XP++ | - |
|''| Skill Advancement XP | 37,500 |
|''| Exodor Justicar credit | 750 |
|''| Exodor Skill Advancement Box Ⅱ | 1 |
...
### 10. System
- Removed KR specific secondary authentication password
...
- Added Kaia's gear upgrading and enchanting materials
  - Tyrant's Belt
    ...
    - Acquired from level 68 and above instances, Execution Arena
  - Tyrant's Soul
    - Used to enchant +6~8 Kaia's Soul Hand Armor / Foot Armor
    - Acquired rfom Execution Arena (hard)
...
source : [K TERA patch archive | seraphinush-gaming](ko/patch/raw/2021/v103-01)
