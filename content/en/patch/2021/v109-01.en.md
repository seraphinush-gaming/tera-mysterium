...
sources = ["[TERA KR patch archive | tera-mysterium](/ko/patch/2021/v109-01)"]
+++
...
- 
  ...
  - A town called Balderon exists in Baldera, and new achievements, adventure, and story can begin
...
|| AWAKE Token : 17 ||
  ...
  - Added new achievements, re-categorized or changed select existing achievements to Legacy Achievements
- Aded [Ace Dungeon] – Rogash's Trial

| [Ace Dungeon] – Rogash's Trial ||
| :-: | :-: |
...
| '' | '' | After | Decrease attack speed by 10%, increase skill damage and effect of healing skills by **(8/10/12/14/16)%** |
...
- Added TERA Pass missions
  - Added new TERA Pass missions, daily mission and repeat mission
