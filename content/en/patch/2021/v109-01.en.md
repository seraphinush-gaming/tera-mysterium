...
### **1.** Open world
- Opened Undiscovered region - Baldera (pl.)
  - Baldera (pl.) can be accessed through 'Ruinweald' located North of Arcadia > Oblivion Woods

![1]

- 
  - Activity level is set to level 71 in Baldera (pl.) and level 70 is recommended
  - A town called Balderon (pl.) exists in Baldera (pl.), and new achievements, adventure, and story can begin
