...
- Fixed issue where Core Reactor (pl.) quest log description did not have proper grammar
...
- Fixed issue where parcel reward for Leaderboard ranking in Core Reactor (pl.) (hard) has 'Killing Grounds (hard)' written
