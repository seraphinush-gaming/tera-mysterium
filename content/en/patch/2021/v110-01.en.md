...
### **4.** Battleground
- Coastal Battleground operates for a limited time
...
| :-: | :-: | :-: | :-: |
| Superior accessory | Shimmering Stardust | 1 | ![10] |
| Mythical accessory | Glimmering Stardust | 2 | ![11] |

- 
  - 
    - *신규 액세서리에 대한 더욱 자세한 내용은 개발자노트 및 추후 인게임을 통해 확인해 보실 수 있습니다. [[신규 액세서리 개발자노트 바로가기]](https://playtera.co.kr/news/devnotes/543)
- Added EXP Gift Box to Meruma's Deluxe Fashion Shop Coin, through which Lv.55, Lv.60 Supply Box can be obtained
