...
### **1.** Guild Conquest Tournament (pl.)
- Added 'Call of the Guild (pl.)' tab to Guild UI, with Guild Conquest Tournament (pl.) event information

![1]

- Guild Conquest Tournament can be entered via 'Donaruld (pl.)' NPC in Velika, Highwatch, Balderon
...
| Monster | Drop item |
| :-: | :-: |
| Sickly Basilisk | Primordial Breath (pl.) |
| Sickly Orisk | '' |
| Sickly Ovolith | '' |
| Brutal Basilisk | '' |
| Brutal Orisk | '' |
| Brutal Ovolith | '' |
| Brutal Bloodbound Teralith | Sacred Essence (pl.) |
| Brutal Fimbrilisk | '' |
| Brutal Searing Fangspawn | '' |
| Brutal Naga Battlemaster | Feather of Dawn (pl.) |
| Brutal Iron Giant | '' |
| Brutal Onyx Hydrath | '' |
...
- 
  ...
  - Added NPC 'Transparent Wing Bareum' in Highwatch and Balderon to teleport to Island of Dawn North Dock
