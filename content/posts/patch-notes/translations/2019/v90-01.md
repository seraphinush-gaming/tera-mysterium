+++
date = "2019-11-28"
title = "2019.11.28 patch notes (v90.01) | KTERA"
...
- Added Valderyon (placeholder) Token System
  - Valderyon (placeholder) Tokens can be obtained via completing Guild Quests
  - Depending on the amount of Valderyon (placeholder) Tokens accumulated, weekly rewards can be received
    - Can be obtained/received up to a max of 3 times, and depending on the guild size and requirements may vary
  - Valderyon (placeholder) Token count resets on Monday 12:00am
  - Guild Quests can be repeated until the maximum amount of Valderyon (placeholder) Tokens is reached
...
- Changed guild quest progression requirement
  - New guild members can contribute to Guild Quests after Valderyon (placeholder) Tokens reset at least once
...
- Other
  - Changed to adjust guild size on Valderyon (placeholder) Token reset
  - New guild members cannot contribute to Guild Quests and receive weekly guild rewards until the next Valderyon (placeholder) Token reset
